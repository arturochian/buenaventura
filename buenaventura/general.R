...
saveRDS(xbrl.vars,"buenaventura2013I.RDS")
buenaventura<-readRDS("buenaventura2013I.RDS")
...
table(buenaventura$fact$elementId)
head(buenaventura$fact)


buenaventura$fact %>%
  filter(elementId=="ifrs_CurrentAssets")%>%
  #  filter(contextId=="id2")%>%
...
names(buenaventura)
dim(buenaventura$footnote)
dim(buenaventura$definition)
View(buenaventura$definition)
View(buenaventura$calculation)
View(buenaventura$context)
View(buenaventura$calculation)
View(buenaventura$unit)
View(buenaventura$presentation)
dim(buenaventura$footnote)
buenaventura
View(buenaventura$footnote)
